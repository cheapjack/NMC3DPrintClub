...
int motorSpeed = 50; // Maximum steps per second (about 3rps / at 16 microsteps)
int motorAccel = 1000; // Steps/second/secoand to accelerate
...
void setup() {
  ...
  stepper.moveTo(200); // move 1000 steps (should be 5 rev)
